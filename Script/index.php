			...
			<div class="row">
				<div class="col-lg-8 col-md-12">
					...
					<div class="block category-listing category-style2 color-red">
						...
						$stmt = $conn->prepare("SELECT * FROM tbl_blog_posts LEFT JOIN tbl_categories ON tbl_blog_posts.category = tbl_categories.id WHERE tbl_blog_posts.visibility = '1' ORDER BY tbl_blog_posts.id DESC LIMIT 7");
						$stmt->execute();
						$result = $stmt->fetchAll();
